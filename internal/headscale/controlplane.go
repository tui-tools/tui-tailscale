...
// what turns tui-tailscale from a viewer into the thing that configures OIDC.
//
...
func appendBlock(lines []string, edits []ConfigEdit) splice {
	...
	out = append(out, "# Added by tui-tailscale.")
	root.render(0, &out)
...
// fetched from this machine itself, because it is the machine that will
